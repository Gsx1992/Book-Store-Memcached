...
require_relative 'commands/insert_book_command'
...
require_relative 'commands/clear_cache_command'
...
commands = [
	...
	InsertBookCommand.new(data_source),
	...
	ClearCacheCommand.new(data_source),
